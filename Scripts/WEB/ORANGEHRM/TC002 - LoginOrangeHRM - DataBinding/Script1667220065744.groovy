...
if(flag == 'null' && tag == 'user') {  
	...
	WebUI.verifyElementText(findTestObject('Object Repository/archive/OR006 - RequiredPassword'), 'Required')
	WebUI.delay(2)
	WebUI.takeScreenshot()
}
	...
	WebUI.waitForElementPresent(findTestObject('Object Repository/archive/OR007 - InvalidCredentials'), 30)
	WebUI.delay(2)
	WebUI.takeScreenshot()
}
